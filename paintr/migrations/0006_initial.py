...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field players on 'Canvas'
        m2m_table_name = db.shorten_name(u'paintr_canvas_players')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('canvas', models.ForeignKey(orm[u'paintr.canvas'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['canvas_id', 'user_id'])
        ...
        db.create_table(u'paintr_point', (
            ...
            ('canvas', self.gf('django.db.models.fields.related.ForeignKey')(default=True, to=orm['paintr.Canvas'])),
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field players on 'Canvas'
        db.delete_table(db.shorten_name(u'paintr_canvas_players'))
    ...
    models = {
        ...
        u'paintr.point': {
            ...
            'canvas': ('django.db.models.fields.related.ForeignKey', [], {'default': 'True', 'to': u"orm['paintr.Canvas']"}),
